                ...
                <div class="card-body">
                  <div class="form-group">
                   ...
                   <select class="form-control" name="category_id">
                      <option value="" disabled {{ old('category_id') == '' ? 'selected' : '' }}>Select One Option</option>
                      @if($categories)
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <textarea class="form-control" name="recommendations[]" rows="8" cols="10"></textarea>
                        @error('recommendations.0')
                          <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                      <div class="col-sm-6">
